...
birthは生年月日、optionsは専門学校や大学院、留年や浪人などのオプションを指定します。
...
## 最終学歴の設定
上記のようにデフォルト値を上書きする方法以外に、最終学歴(last_academic_background)を渡すことで戻り値の学歴リストを指定することもできます。（デモ２で使用しています）
また、留年や浪人などの設定も併用できます。
